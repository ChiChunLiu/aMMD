...
param_directory="/scratch/cliu7/ancient_ACA/output/qpgraph/Loschbour"
...
# for b in ${basalEA}
# do
# 	cp ${b}_4pops_DevilsGate/Mbuti.Loschbour.${b}.Ami.DevilsGate.1way.4.graph\
...
# for b in ${basalEA}
# do
#         cp ${b}_6pops_Upper_YR_LN/Mbuti.Loschbour.${b}.Ami.DevilsGate.Mixe.Upper_YR_LN.2way.32.graph \
#                 Mbuti.Loschbour.${b}.Ami.DevilsGate.Mixe.Upper_YR_LN.graph
# done

# # groups="Lubrak Kyang Mebrak Rhirhi Samdzong Chokhopani Sherpa.LC Tibetan_Shannan UpperMustang.LC"
# groups="Lubrak Sherpa.LC Suila"

# make_directories "$groups" "$basalEA" 7

# for b in ${basalEA}; do
#     cd ${b}_7pops_Kyang
#     graph1="Mbuti.Loschbour.${b}.Ami.DevilsGate.Mixe.Upper_YR_LN"
