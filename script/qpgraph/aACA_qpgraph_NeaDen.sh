...
basalEA="Tianyuan"
# create ((MA-1, Mbuti), Denisovan)
${graphwriter} --pop=Denisovan,Mbuti > Denisovan.Mbuti.graph
${graphwriter} --in=Denisovan.Mbuti --pop=Loschbour --at=b_n000_n002
mv Denisovan.Mbuti.Loschbour.1.graph Denisovan.Mbuti.Loschbour.graph
...
# 	cd ${b}_3pops_Ami
# 	graph1="Denisovan.Mbuti.Loschbour"
...
# for b in ${basalEA}
# do
#     cp ${b}_3pops_Ami/Denisovan.Mbuti.Loschbour.Ami.1way.4.graph \
#        Denisovan.Mbuti.Loschbour.Ami.graph
# done
...
# 	graph1="Denisovan.Mbuti.Loschbour.Ami"
...
for b in ${basalEA}
do
    cp ${b}_4pops_Tianyuan/Denisovan.Mbuti.Loschbour.Ami.Tianyuan.2way.9.graph \
       Denisovan.Mbuti.Loschbour.Ami.Tianyuan.graph
done
...
do
	...
	graph1="Denisovan.Mbuti.Loschbour.Ami.Tianyuan"
...
for b in ${basalEA}
do
    cp ${b}_5pops_DevilsGate/Denisovan.Mbuti.$1.Tianyuan.Ami.DevilsGate.1way.8.graph \
       Denisovan.Mbuti.$1.Tianyuan.Ami.DevilsGate.graph
done
...
do
	...
	cd ${b}_6pops_Mixe
	graph1="Denisovan.Mbuti.$1.Tianyuan.Ami.DevilsGate"
...
# for b in ${basalEA}
# do
#     cp ${b}_6pops_Mixe/Denisovan.Mbuti.$1.Tianyuan.Ami.DevilsGate.Mixe.2way.35.graph \
#        Denisovan.Mbuti.$1.Tianyuan.Ami.DevilsGate.Mixe.graph
# done
...
# 	graph1="Denisovan.Mbuti.$1.Tianyuan.Ami.DevilsGate.Mixe"
...
# for b in ${basalEA}
# do
#     cp ${b}_7pops_Upper_YR_LN/Denisovan.Mbuti.$1.Tianyuan.Ami.DevilsGate.Mixe.Upper_YR_LN.2way.82.graph \
#        Denisovan.Mbuti.$1.Tianyuan.Ami.DevilsGate.Mixe.Upper_YR_LN.graph
# done
...
# do
# 	cd ${b}_8pops_Kyang
# 	graph1="Denisovan.Mbuti.$1.Tianyuan.Ami.DevilsGate.Mixe.Upper_YR_LN"
